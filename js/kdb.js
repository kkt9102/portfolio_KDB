...
function btn_menu_open() {
  /*
  $('.section-2 > .section-2-bottom-menu-item > .section-2-bottom-menu-box > ul > .btn-item').click(function(){
    $(this).addClass('active');
  });
  $('.section-2 > .section-2-bottom-menu-item > .section-2-bottom-menu-box > ul > .btn-item .close-btn').click(function(){
    $('.section-2 > .section-2-bottom-menu-item > .section-2-bottom-menu-box > ul > .btn-item.active').removeClass('active');
  });
  */
